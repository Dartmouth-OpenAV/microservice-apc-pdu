...
curl -X GET "http://${MICROSERVICE_URL}/${DEVICE_FQDN}/state/1"
sleep 1

# GET all outlets status
echo "Testing GET all outlets status..."
curl -X GET "http://${MICROSERVICE_URL}/${DEVICE_FQDN}/allOutlets"
sleep 1

# SET outlet on
echo "Testing SET outlet 1 on..."
curl -X PUT "http://${MICROSERVICE_URL}/${DEVICE_FQDN}/state/1" \
...
curl -X PUT "http://${MICROSERVICE_URL}/${DEVICE_FQDN}/state/2" \
     -H "Content-Type: application/json" \
     -d '"off"'
sleep 3
...
curl -X PUT "http://${MICROSERVICE_URL}/${DEVICE_FQDN}/state/1-3" \
     -H "Content-Type: application/json" \
     -d '"on"'
sleep 3
...
curl -X PUT "http://${MICROSERVICE_URL}/${DEVICE_FQDN}/state/all" \
     -H "Content-Type: application/json" \
     -d '"off"'
sleep 3
...
curl -X POST "http://${MICROSERVICE_URL}/${DEVICE_FQDN}/powerCycle/1" \
     -H "Content-Type: application/json" \
     -d '"3"'
sleep 5
...
curl -X POST "http://${MICROSERVICE_URL}/${DEVICE_FQDN}/powerCycle/2-4" \
     -H "Content-Type: application/json" \
     -d '"5"'
sleep 7
